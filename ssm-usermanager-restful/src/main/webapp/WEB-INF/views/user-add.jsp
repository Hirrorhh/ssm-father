...
<div style="padding:10px 10px 10px 10px">
	<form id="content" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>用户名:</td>
	            <td><input type="hidden" name="id" id="id"/><input class="easyui-textbox" type="text" name="userName" data-options="required:true" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>密码:</td>
	        ...
	        <tr>
	            <td>年龄:</td>
	            <td><input class="easyui-numberbox" type="text" name="age" data-options="min:1,max:150,precision:0,required:true" />
	            </td>
	        </tr>
	        <tr>
	            <td>性别:</td>
...
<script type="text/javascript">
	function submitForm(){
		...
		$.post("/user",$("#content").serialize(), function(data){
			if(data == '204'){
